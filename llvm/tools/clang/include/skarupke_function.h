...
#ifndef SKARUPKE_FUNCTION_H
#define SKARUPKE_FUNCTION_H
...
} // end namespace skarupke

namespace std
{
template<typename Result, typename... Arguments, typename Allocator>
struct uses_allocator<skarupke::function<Result (Arguments...)>, Allocator>
  : std::true_type
{
};
}
