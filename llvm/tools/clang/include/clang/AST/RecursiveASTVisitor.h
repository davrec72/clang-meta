...
//END
//DEF_TRAVERSE_STMT(CXXInjectionStmt, {}) //ASUTTON ADDN
DEF_TRAVERSE_STMT(CXXQueueMetaparseStmt, {}) //DWR ADDN
DEF_TRAVERSE_STMT(CXXMetaparseExpr, {}) //DWR ADDN
//DEF_TRAVERSE_STMT(CXXExtensionStmt, {}) //ASUTTON ADDN
...
DEF_TRAVERSE_STMT(CXXConstantExpr, {}) //ASUTTON ADDN
DEF_TRAVERSE_STMT(CXXDependentIdExpr, {}) //ASUTTON ADDN
//DEF_TRAVERSE_STMT(CXXFragmentExpr, {}) //ASUTTON ADDN
DEF_TRAVERSE_STMT(CXXConcatenateExpr, {}) //ASUTTON ADDN
...
//DEF_TRAVERSE_STMT(ReflectionTraitTypedExpr, {}) //DWR ADDN
DEF_TRAVERSE_STMT(ReflectNewExpr, {}) //DWR ADDN
DEF_TRAVERSE_STMT(ReflectDeleteExpr, {}) //DWR ADDN
//DEF_TRAVERSE_STMT(VoidReflectionExpr, {}) //DWR ADDN
//DEF_TRAVERSE_STMT(NonvoidReflectionExpr, {}) //DWR ADDN
//END
DEF_TRAVERSE_STMT(CompilerMessageExpr, {}) //ASUTTON ADDN
DEF_TRAVERSE_STMT(CompilerDiagnosticExpr, {}) //DWR ADDN
