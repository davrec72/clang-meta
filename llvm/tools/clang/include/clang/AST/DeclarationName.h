...
class CXXIdExprNameExtra; //ASUTTON ADDN
class DeclarationNameExtra;
//class Expr; //ASUTTON ADDN
...
//ASUTTON ADDN:
  ...
  /// of arguments.
  llvm::ArrayRef<class Expr *> getCXXIdExprArguments() const;
//END
