...
//DWR ADDN:
  /// True if it is function like AND the parameters were enclosed in braces,
  /// e.g. #define MyMacro{x, y, ...} x ## y(__VA_ARGS__)
  bool ParamsInBraces : 1;
//END
...
//DWR ADDN:
  /// For function-like macros, tells whether the parameters are enclosed in braces
  void setParamsInBraces() { ParamsInBraces = true; }
  bool paramsInBraces() const { return ParamsInBraces; }
  bool paramsInParens() const { return !ParamsInBraces; }
//END
