...
/// \brief A ReflectedTYpe record.
      , TYPE_REFLECTED  = 49 //DWR NOTE: it was 47 in orig code
//END
    };
...
//END
////ASUTTON ADDN:
//      /// \brief A CXXInjectionStmt record.
//      STMT_CXX_INJECTION,
////END
//DWR ADDN:
      /// \brief A CXXQueueMetaparseStmt record.
      STMT_CXX_QUEUE_METAPARSE,
//END
////ASUTTON ADDN:
//      /// \brief A CXXExtension record.
//      STMT_CXX_EXTENSION,
////END
      ...
      // [Meta] C++ Reflection
      EXPR_COMPILER_MESSAGE,      // CompilerMessageExpr //ASUTTON ADDN
      EXPR_COMPILER_DIAGNOSTIC,   // CompilerDiagnosticExpr //DWR ADDN
      //DWR TODO what about EXPR_REFLECTION_TRAIT etc.?
//DWR ADDN
      /// \brief A CXXMetaparseExpr record.
      EXPR_CXX_METAPARSE,
//END
      // CUDA
