...
//DWR ADDN:
    /// Governs whether InstantiatedLocal etc. methods should not only add their decls to the LocalDecls
    /// member, but also to SemaRef.Scope and SemaRef.IdResolver.
...
//END
  ...
  public:
    LocalInstantiationScope(Sema &SemaRef, bool CombineWithOuterScope = false)
        ...
        , ShouldCopyToSemaScopeEtc(SemaRef.getPII() == Sema::PII_func) //DWR ADDN
           {
...
//END
    ...
    : public DeclVisitor<TemplateDeclInstantiator, Decl *>
  {
    ...
    ParsedAttributesWithRange *AccessAttrs; //DWR ADDN
  ...
  public:
    ...
    ParsedAttributesWithRange &getAccessAttrs() {
      assert(AccessAttrs && "Only call this if you've constructed this "
