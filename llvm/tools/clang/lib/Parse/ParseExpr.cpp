...
/// [clang] '^' block-literal
/// [Meta]  reflection-expression (ASUTTON ADDN)
/// [Meta]  fragment-expression
/// [Meta]  unary-reflection-trait '(' expression ')' //DWR FIXME
/// [Meta]  binary-reflection-trait '(' expression ',' expression ')' //DWR FIXME
/// [Meta]  '__compiler_debug' '(' constant-expression ')' //ASUTTON ADDN/DWR MOD
/// [Meta]  '__compiler_diag' '(' /*TODO*/ ')' //DWR ADDN
///
///       constant: [C99 6.4.4]
///         integer-constant
///         floating-constant
...
///                   '__is_rvalue_expr'
///
/// [Meta] unary-reflection-trait: (ASUTTON ADDN)
///          '__reflect_unqualified_name'
///          '__reflect_qualified_name'
///          '__reflect_type'
///          '__reflect_type_name' //DWR ADDN
///          '__reflect_traits'
...
#include "clang/Basic/OpenCLImageTypes.def"
  ...
  case tok::kw_idexpr: // [Meta] id-expression: idexpr-id //ASUTTON ADDN
    Res = ParseCXXIdExpression(isAddressOfOperand);
    break;
...
//ASUTTON ADDN:
////DWR COMMENTED OUT: only one reflection trait now
//#define REFLECTION_TRAIT(N,Spelling,K) \
//  case tok::kw_##Spelling:
//#include "clang/Basic/TokenKinds.def"
////END
//DWR ADDN:
  case tok::kw___reflect_prop:
    return ParseReflectionTrait(RTK_prop);
  case tok::kw___reflect_range_nth:
    return ParseReflectionTrait(RTK_range_nth);
  case tok::kw___reflect_range_size:
    return ParseReflectionTrait(RTK_range_size);
  case tok::kw___reflect_cast:
    return ParseReflectionTrait(RTK_cast);
  case tok::kw___reflect_new:
    return ParseReflectNew();
  case tok::kw___reflect_delete:
    return ParseReflectDelete();
  case tok::kw___metaparse_expr:
    return ParseCXXMetaparseExpr();
//END
//ASUTTON ADDN/DWR MOD:
  // [Meta] primary-expression: '__compiler_debug' '(' constant-expression ')'
  case tok::kw___compiler_debug:
    Res = ParseCompilerMessageExpression();
    break;
//END
//DWR ADDN:
  case tok::kw___compiler_diag:
    Res = ParseCompilerDiagnosticExpression();
    break;
//END
//ASUTTON ADDN:
...
//DWR NOTE moved ParseCompilerMessageExpr stuff to ParseReflect.cpp
