...
//    void VisitMetaclassDecl(MetaclassDecl *D); //ASUTTON ADDN
    ...
    void VisitConstexprDecl(ConstexprDecl *D); //ASUTTON ADDN
//    void VisitCXXFragmentDecl(CXXFragmentDecl *D); //ASUTTON ADDN
//    void VisitCXXInjectionDecl(CXXInjectionDecl *D); //ASUTTON ADDN
...
//  Record.AddStmt(D->getGenerator()); //ASUTTON ADDN
