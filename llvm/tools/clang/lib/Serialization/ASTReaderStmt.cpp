...
//END
//DWR ADDN:
//void ASTStmtReader::VisitReflectionTraitTypedExpr(ReflectionTraitTypedExpr *E) {
//  llvm_unreachable("unimplemented");
//}
void ASTStmtReader::VisitReflectNewExpr(ReflectNewExpr *E) {
  llvm_unreachable("unimplemented");
}
void ASTStmtReader::VisitReflectDeleteExpr(ReflectDeleteExpr *E) {
  llvm_unreachable("unimplemented");
}
//END
////DWR OLD:
//void ASTStmtReader::VisitVoidReflectionExpr(VoidReflectionExpr *E) {
//  llvm_unreachable("unimplemented");
//}
//void ASTStmtReader::VisitNonvoidReflectionExpr(NonvoidReflectionExpr *E) {
//  llvm_unreachable("unimplemented");
//}
////END
//ASUTTON ADDN:
void ASTStmtReader::VisitCompilerMessageExpr(CompilerMessageExpr *E) {
  VisitExpr(E);
  E->setMessage(Record.readSubExpr());
  E->setKWLoc(ReadSourceLocation());
  E->setRParenLoc(ReadSourceLocation());
}
//END
//DWR ADDN (TESTME)
void ASTStmtReader::VisitCompilerDiagnosticExpr(CompilerDiagnosticExpr *E) {
  VisitExpr(E);
  E->setKWLoc(ReadSourceLocation());
...
////END
//DWR ADDN:
void ASTStmtReader::VisitCXXQueueMetaparseStmt(CXXQueueMetaparseStmt *S) {
  VisitStmt(S);
  // DWR FIXME!!: Implement me!
}
//DWR ADDN:
void ASTStmtReader::VisitCXXMetaparseExpr(CXXMetaparseExpr *E) {
  VisitExpr(E);
  // DWR FIXME!!: Implement me!
}
//END
...
////ASUTTON ADDN:
//
//void ASTStmtReader::VisitCXXExtensionStmt(CXXExtensionStmt *S) {
//  VisitStmt(S);
//  // FIXME: Implement me.
//}
////END
...
////END
//DWR ADDN:
    case STMT_CXX_QUEUE_METAPARSE:
      S = new (Context) CXXQueueMetaparseStmt(Empty);
      break;
//END
////ASUTTON ADDN:
//    case STMT_CXX_EXTENSION:
//      S = new (Context) CXXExtensionStmt(Empty);
//      break;
////END
    ...
    case EXPR_DEPENDENT_COAWAIT:
      ...
      break;
//ASUTTON ADDN:
    case EXPR_COMPILER_MESSAGE:
      S = CompilerMessageExpr::CreateEmpty(Context, Empty);
      break;
//END
//DWR ADDN:
    case EXPR_COMPILER_DIAGNOSTIC: {
      unsigned NumArgs = Record[ASTStmtReader::NumStmtFields];
      S = CompilerDiagnosticExpr::CreateEmpty(Context, NumArgs);
      break;
    }
//END
//DWR ADDN:
    case EXPR_CXX_METAPARSE:
      S = new (Context) CXXMetaparseExpr(Empty);
      break;
//END
      //DWR TODO what about EXPR_REFLECTION_TRAIT etc.?
    }
...
//  //DWR TEMP DEBUG
//  if (StmtStack.size() <= PrevNumStmts) {
//    llvm::errs() << "DWR TEMP DEBUG StmtStack.size()/PrevNumStmts/all S dump: " << StmtStack.size() << "/" << PrevNumStmts << "/\n";
//    for (auto S : StmtStack) {
//      if (S)
//        S->dump();
//      else
//        llvm::errs() << "[Null S!]\n";
//    }
//    llvm_unreachable("Read too many sub-stmts!");
//  }
//  //END
