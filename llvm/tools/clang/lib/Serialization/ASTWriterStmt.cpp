...
//END
//DWR ADDN:
//void ASTStmtWriter::VisitReflectionTraitTypedExpr(ReflectionTraitTypedExpr *E) {
//  llvm_unreachable("unimplemented");
//}
void ASTStmtWriter::VisitReflectNewExpr(ReflectNewExpr *E) {
  llvm_unreachable("unimplemented");
}
void ASTStmtWriter::VisitReflectDeleteExpr(ReflectDeleteExpr *E) {
  llvm_unreachable("unimplemented");
}
//END
////DWR OLD:
//void ASTStmtWriter::VisitVoidReflectionExpr(VoidReflectionExpr *E) {
//  llvm_unreachable("unimplemented");
//}
//void ASTStmtWriter::VisitNonvoidReflectionExpr(NonvoidReflectionExpr *E) {
//  llvm_unreachable("unimplemented");
//}
////END
//ASUTTON ADDN:
void ASTStmtWriter::VisitCompilerMessageExpr(CompilerMessageExpr *E) {
  VisitExpr(E);
  //DWR FIXME: account for isError()/isWarning()
  Record.AddStmt(E->getMessage());
  Record.AddSourceLocation(E->getKWLoc());
  Record.AddSourceLocation(E->getRParenLoc());
  Code = serialization::EXPR_COMPILER_MESSAGE;
}
//END
//DWR ADDN:
void ASTStmtWriter::VisitCompilerDiagnosticExpr(CompilerDiagnosticExpr *E) {
  VisitExpr(E);
  Record.AddSourceLocation(E->getKWLoc());
  for (unsigned I = 0, N = E->arg_size(); I != N; ++I)
      Record.AddStmt(E->getArg(I));
  Record.AddSourceLocation(E->getRParenLoc());
  Code = serialization::EXPR_COMPILER_DIAGNOSTIC;
}
//END
//ASUTTON ADDN:
...
////END
//DWR ADDN:
void ASTStmtWriter::VisitCXXQueueMetaparseStmt(CXXQueueMetaparseStmt *S) {
  VisitStmt(S);
  // DWR FIXME!!: Implement me!!
  Code = serialization::STMT_CXX_QUEUE_METAPARSE;
}

void ASTStmtWriter::VisitCXXMetaparseExpr(CXXMetaparseExpr *E) {
  VisitExpr(E);
  // DWR FIXME!!: Implement me!!
  Code = serialization::EXPR_CXX_METAPARSE;
}
//END
////ASUTTON ADDN:
//void ASTStmtWriter::VisitCXXExtensionStmt(CXXExtensionStmt *S) {
//  VisitStmt(S);
//  // FIXME: Implement me.
//  Code = serialization::STMT_CXX_EXTENSION;
//}
////END
