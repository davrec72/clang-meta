...
CXXExpansionStmt::CXXExpansionStmt(StmtClass SC, DeclStmt *Range,
    ...
    : Stmt(SC), ForLoc(FL), ColonLoc(CL), RParenLoc(RPL),
      CB_getSize(CB_getSize), //DWR MOD
      SemaPtr(&SemaRef), //DWR ADDN
...
CXXTupleExpansionStmt::CXXTupleExpansionStmt(
    TemplateParameterList *TP, DeclStmt *RangeVar,
    DeclStmt *LoopVar, Stmt *Body,
    std::function<std::size_t()> CB_getSize, //DWR MOD
    SourceLocation FL, SourceLocation EL,
    SourceLocation CL, SourceLocation RPL
    ...
    : CXXExpansionStmt(CXXTupleExpansionStmtClass, RangeVar, LoopVar, Body,
                       CB_getSize, //DWR MOD
                       FL, EL, CL, RPL
                       , SemaRef //DWR ADDN
                       ),
...
CXXPackExpansionStmt::CXXPackExpansionStmt(DeclStmt *RangeVar,
                                           ...
                                           SourceLocation RPL,
                                           Sema &SemaRef)
    : CXXExpansionStmt(CXXPackExpansionStmtClass, RangeVar, LoopVar, Body, nullptr/*CB_getSize*/,
                       FL, EL, CL, RPL, SemaRef) {}
//END ASUTTON ADDN
