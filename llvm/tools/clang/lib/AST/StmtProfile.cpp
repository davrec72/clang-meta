...
////END
//DWR ADDN:
void StmtProfiler::VisitCXXQueueMetaparseStmt(const CXXQueueMetaparseStmt *S) {
  VisitStmt(S);
}
//END
////ASUTTON ADDN:
...
//END
//DWR ADDN:
//void StmtProfiler::VisitReflectionTraitTypedExpr(const ReflectionTraitTypedExpr *E) {
//  VisitExpr(E);
//}
void StmtProfiler::VisitReflectNewExpr(const ReflectNewExpr *E) {
  VisitExpr(E);
}
void StmtProfiler::VisitReflectDeleteExpr(const ReflectDeleteExpr *E) {
  VisitExpr(E);
}
void StmtProfiler::VisitCXXMetaparseExpr(const CXXMetaparseExpr *E) {
  VisitExpr(E);
}
void StmtProfiler::VisitCompilerDiagnosticExpr(const CompilerDiagnosticExpr *E) {
  VisitExpr(E);
}
//END
//ASUTTON ADDN:
void StmtProfiler::VisitCompilerMessageExpr(const CompilerMessageExpr *E) {
  VisitExpr(E);
}
//END
////ASUTTON ADDN:
