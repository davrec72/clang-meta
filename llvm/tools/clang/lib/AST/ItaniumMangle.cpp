...
//ASUTTON ADDN:
    case DeclarationName::CXXIdExprName:
      llvm_unreachable("Can't mangle an idexpr name!");
//END
...
#include "clang/AST/StmtNodes.inc"
  ...
  case Expr::CXXDependentIdExprClass: //ASUTTON ADDN
  case Expr::CompilerMessageExprClass: //ASUTTON ADDN
...
//  case Expr::NonvoidReflectionExprClass: //DWR ADDN
  ...
  case Expr::CXXConcatenateExprClass: //DWR ADDN
