...
///// identifier.
//StringRef NamedDecl::getName() const {
//  assert(Name.isIdentifier() && "Name is not a simple identifier");
//  //^ DWR COMMENTED OUT so we don't get failed assertions in reflection.
//  //   (DWR NOTE: getIdentifier() condition below was already there.)
