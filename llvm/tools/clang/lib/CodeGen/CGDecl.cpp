...
void CodeGenFunction::EmitDecl(const Decl &D) {
  ...
  case Decl::Binding:
//  case Decl::Metaclass: // $class X { ... } //ASUTTON ADDN
  case Decl::Constexpr: // constexpr { ... } //ASUTTON ADDN
//  case Decl::CXXInjection: // __inject expr; //ASUTTON ADDN
//  case Decl::CXXFragment: // __fragment decl; //ASUTTON ADDN:
//    llvm_unreachable("Declaration should not be in declstmts!"); //DWR TEST COMMENTED OUT
