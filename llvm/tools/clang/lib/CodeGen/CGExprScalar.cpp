...
//ASUTTON ADDN/DWR MOD:
  Value *VisitCompilerDiagnosticExpr(CompilerDiagnosticExpr *E) {
    ...
    // ill-formed.
    if (E->isError()) //DWR ADDN
      return CGF.EmitTrapCall(llvm::Intrinsic::trap);
    return EmitNullValue(E->getType()); //DWR ADDN: if warning, don't abort
  }
//END
//DWR ADDN:
  Value *VisitCompilerMessageExpr(CompilerMessageExpr *E) {
    return EmitNullValue(E->getType()); //DWR ADDN
  }
//END  
////ASUTTON ADDN: (FIXME: EmitConstantValue no longer exists)
...
//END
//DWR ADDN (no clue about any of this stuff)
//  Value *VisitReflectionTraitTypedExpr(const ReflectionTraitTypedExpr *E) {
//    return nullptr;
//  }
  Value *VisitReflectNewExpr(const ReflectNewExpr *E) {
    return nullptr;
  }
  Value *VisitReflectDeleteExpr(const ReflectDeleteExpr *E) {
    return nullptr;
  }
//END
////DWR OLD:
//  Value *VisitVoidReflectionExpr(const VoidReflectionExpr *E) {
//    return nullptr;
//  }
//  Value *VisitNonvoidReflectionExpr(const NonvoidReflectionExpr *E) {
//    return nullptr;
//  }
////END
