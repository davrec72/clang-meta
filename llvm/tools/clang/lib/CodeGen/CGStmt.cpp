...
bool CodeGenFunction::EmitSimpleStmt(const Stmt *S) {
  ...
  //case Stmt::CXXInjectionStmtClass: break; //ASUTTON ADDN
  case Stmt::CXXQueueMetaparseStmtClass: break; //DWR ADDN
  }
...
//  llvm_unreachable("DWR: Need to fix implementation I think getSize() will probably always"
//                   "return 0 for non-const refleciton containers here, and if that is case then"
//                   "for all expansions getInstaniatedStmts will be empty too since we moved "
//                   "the instantiation stuff to ExprConstant.cpp."
//                   "Bottom line you need to think this one out, lots of dependencies based on"
//                   "previously evaluated compile-time results, meaning an intermediate representation"
//                   "might not quite be consistent with this...or at least needs a lot of deep thought... ");
