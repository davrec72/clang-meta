...
//DWR TEST COMMENTED OUT: macros defined with meta parsed sources make these fail
//DWR TODO try to condition this on ParsingFromMetaSrc, by giving a Preprocessor &PP data mem somewhere or something, at least in debug mode
  assert((macroStart.isFileID()
          || firstToken.is(tok::comment)
