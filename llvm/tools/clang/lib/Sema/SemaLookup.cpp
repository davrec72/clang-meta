...
bool Sema::CppLookupName(LookupResult &R, Scope *S) {
  ...
  IdentifierResolver::iterator I = IdResolver.begin(Name), IEnd = IdResolver.end();
  ...
  } //end for loop over scope ancestors:
  //DWR NOTE: At this point S should be a namespace/translation unit scope
