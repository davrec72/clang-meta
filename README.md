...
3) **custom static diagnostics** (pointing to locations *you* define, with fixits *you* define, displayed by your IDE *just like* the built-in diagnostics), and
...
Please see the examples folder for an in-depth tutorial; here are just some basic syntax examples:
